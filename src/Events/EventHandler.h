...
{
		extern "C" void RaiseEvent(const wchar_t*, void*);						/* Raises an event of provided name, passing a pointer to an eventArgs struct */
		extern "C" void SubscribeEvent(const wchar_t*, ConsumeEventCallback);	/* Subscribes the provided ConsumeEventCallback function, to the provided event name */
