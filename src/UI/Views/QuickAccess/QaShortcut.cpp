...
namespace Raidcore::Nexus::GUI
{
	...
	bool CShortcutIcon::Render()
	{
		...
		if (this->ContextItems.size() > 0)
		{
			...
			{
				Runtime& ctx = Runtime::Get();
				this->Textures[ETexIdx::HasContextMenu] = this->TextureService->GetOrCreate("ICON_CONTEXTMENU", RES_ICON_CONTEXTMENU_AVAILABLE, GetCurrentModule());
			}
			else
			{
				ImGui::PushItemFlag(ImGuiItemFlags_Disabled, true);
	...
	Graphics::Texture_t* CShortcutIcon::GetNotificationTexture(uint32_t aAmount)
	{
		...
		if (!icon)
		{
			...
			switch (aAmount)
			{
				case 1:  icon = this->Textures[ETexIdx::Notify1] = this->TextureService->GetOrCreate("QA_NOTIFY1", RES_ICON_NOTIFICATION1, GetCurrentModule()); break;
				case 2:  icon = this->Textures[ETexIdx::Notify2] = this->TextureService->GetOrCreate("QA_NOTIFY2", RES_ICON_NOTIFICATION2, GetCurrentModule()); break;
				case 3:  icon = this->Textures[ETexIdx::Notify3] = this->TextureService->GetOrCreate("QA_NOTIFY3", RES_ICON_NOTIFICATION3, GetCurrentModule()); break;
				case 4:  icon = this->Textures[ETexIdx::Notify4] = this->TextureService->GetOrCreate("QA_NOTIFY4", RES_ICON_NOTIFICATION4, GetCurrentModule()); break;
				case 5:  icon = this->Textures[ETexIdx::Notify5] = this->TextureService->GetOrCreate("QA_NOTIFY5", RES_ICON_NOTIFICATION5, GetCurrentModule()); break;
				case 6:  icon = this->Textures[ETexIdx::Notify6] = this->TextureService->GetOrCreate("QA_NOTIFY6", RES_ICON_NOTIFICATION6, GetCurrentModule()); break;
				case 7:  icon = this->Textures[ETexIdx::Notify7] = this->TextureService->GetOrCreate("QA_NOTIFY7", RES_ICON_NOTIFICATION7, GetCurrentModule()); break;
				case 8:  icon = this->Textures[ETexIdx::Notify8] = this->TextureService->GetOrCreate("QA_NOTIFY8", RES_ICON_NOTIFICATION8, GetCurrentModule()); break;
				case 9:  icon = this->Textures[ETexIdx::Notify9] = this->TextureService->GetOrCreate("QA_NOTIFY9", RES_ICON_NOTIFICATION9, GetCurrentModule()); break;
				default: icon = this->Textures[ETexIdx::NotifyX] = this->TextureService->GetOrCreate("QA_NOTIFYX", RES_ICON_NOTIFICATIONX, GetCurrentModule()); break;
			}
		}
