...
typedef void (*QUICKACCESS_ADDSHORTCUT)				(std::string aIdentifier, Texture aTexture, Texture aTextureHover, std::string aKeybindIdentifier, std::string aTooltipText);
